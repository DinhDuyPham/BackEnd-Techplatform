...
public enum RestStatusMessage {
    ...
    BLOG_ALREADY_EXISTED, INVALID_PRICE_FORMAT, INVALID_DISCOUNT_FORMAT, INVALID_COURSE_TYPE_FORMAT, LESSON_ALREADY_EXISTED, INVALID_URL_FORMAT, LESSON_NOT_FOUND,
}
