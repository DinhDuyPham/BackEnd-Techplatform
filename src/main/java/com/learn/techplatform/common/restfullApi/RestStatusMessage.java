...
public enum RestStatusMessage {
    ...
    NO_RESULT, INVALID_FORMAT_OR_SIZE, UPLOAD_IMAGE_FAILED, COURSE_NOT_FOUND, INVALID_LASTNAME_FORMAT, INVALID_FIRSTNAME_FORMAT, INVALID_BIO_FORMAT, INVALID_GENDER_FORMAT, NO_RESULT
}
