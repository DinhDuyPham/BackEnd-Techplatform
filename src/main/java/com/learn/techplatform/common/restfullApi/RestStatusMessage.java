...
public enum RestStatusMessage {
    ...
    NO_RESULT, INVALID_FORMAT_OR_SIZE, UPLOAD_IMAGE_FAILED, COURSE_NOT_FOUND, INVALID_LASTNAME_FORMAT, INVALID_FIRSTNAME_FORMAT, INVALID_BIO_FORMAT, INVALID_CONTENT_FORMAT, BLOG_NOT_FOUND, isCourseExist,
    BLOG_ALREADY_EXISTED, INVALID_PRICE_FORMAT, INVALID_DISCOUNT_FORMAT, INVALID_COURSE_TYPE_FORMAT,
}
