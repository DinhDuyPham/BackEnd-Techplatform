...
public enum RestStatusMessage {
    ...
    INVALID_TITLE_FORMAT, COURSE_ALREADY_EXISTED, INVALID_DESCRIPTION_FORMAT, INVALID_GENDER_FORMAT,
    NO_RESULT, INVALID_FORMAT_OR_SIZE, UPLOAD_IMAGE_FAILED, COURSE_NOT_FOUND, INVALID_LASTNAME_FORMAT, INVALID_FIRSTNAME_FORMAT, INVALID_BIO_FORMAT, INVALID_CONTENT_FORMAT, BLOG_NOT_FOUND,
    BLOG_ALREADY_EXISTED, INVALID_PRICE_FORMAT, INVALID_DISCOUNT_FORMAT, INVALID_COURSE_TYPE_FORMAT, LESSON_ALREADY_EXISTED, INVALID_URL_FORMAT, LESSON_NOT_FOUND, NOTIFICATION_NOT_FOUND, NOTIFICATION_ALREADY_EXISTED, INVALID_LINKED_FORMAT,NOT_FOUND,
    NEXT_LESSON_NOT_FOUND,FAIL
}
